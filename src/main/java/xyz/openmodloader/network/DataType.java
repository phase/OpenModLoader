...
public class DataType<T> {
    ...
    public static final DataType<ITextComponent> TEXT_COMPONENT = new DataType<>(ITextComponent.class, (buf, component) -> {
        String json = ITextComponent.a.componentToJson(component);
        buf.writeInt(json.length());
        buf.writeString(json);
    }, buf -> ITextComponent.a.jsonToComponent(buf.readStringFromBuffer(buf.readInt())));
