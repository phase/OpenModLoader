...
public class ExplosionEvent extends Event {
    ...
    public static Explosion onExplosion(World world, Entity entity, double x, double y, double z, float explosionSize, boolean isFlaming, boolean isSmoking) {
        ...
        return OpenModLoader.getEventBus().post(event) ? new Explosion(event.world, event.entity, event.x, event.y, event.z, event.explosionSize, event.isFlaming, event.isSmoking) : null;
    }
}